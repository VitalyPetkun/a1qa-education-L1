...
public class AlertsTest extends BaseTest{
    ...
    public void checkAlerts(@Optional("https://demoqa.com/") String url) {
        ...
        Assert.assertEquals(alertsWindowsPage.getAlertsForm().getAlertUtils().getTextAlert(),"You clicked a button",
        ...
        Assert.assertEquals(alertsWindowsPage.getAlertsForm().getAlertUtils().getTextAlert(), "Do you confirm action?",
        ...
        Assert.assertEquals(alertsWindowsPage.getAlertsForm().getAlertUtils().getTextAlert(), "Please enter your name",
        ...
        alertsWindowsPage.getAlertsForm().getAlertUtils().clickBtnOk();
        Assert.assertTrue(!alertsWindowsPage.getAlertsForm().getAlertUtils().isAlertOpen(), "Alert did not close.");
        Assert.assertEquals(alertsWindowsPage.getAlertsForm().getTextBtnPromt(), "Hello World",
                "The inscription 'You selected Ok' did not appear next to the button");
